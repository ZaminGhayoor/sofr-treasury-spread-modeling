...
df["ResidualSpread"] = df["Spread"] - df["IssuerEffect"]
...
df["ComputedYield"] = df["BenchmarkRate"] + df["IssuerEffect"] + df["ResidualPred"]
...
df.to_csv("v8_results.csv", index=False)
print("\nSaved: v8_results.csv")
